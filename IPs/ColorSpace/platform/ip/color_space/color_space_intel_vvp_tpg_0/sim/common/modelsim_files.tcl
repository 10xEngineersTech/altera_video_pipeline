...
namespace eval color_space_intel_vvp_tpg_0 {
  proc get_design_libraries {} {
    ...
    dict set libraries color_space_intel_vvp_tpg_0            1
    return $libraries
  }
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_vvp_tpg_2451/sim/color_space_intel_vvp_tpg_0_intel_vvp_tpg_2451_fjcws5y.v"]\"  -work intel_vvp_tpg_2451"                                                                   
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/color_space_intel_vvp_tpg_0.v"]\"  -work color_space_intel_vvp_tpg_0"                                                                                                               
    return $design_files
  }
