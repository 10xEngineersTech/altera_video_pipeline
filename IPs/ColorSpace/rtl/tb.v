...
module tb();
    ...
    make_file #(
        ...
        .tdata      (dut.intel_vvp_tpg_0_axi4s_vid_out_tdata),
        .tvalid     (dut.intel_vvp_tpg_0_axi4s_vid_out_tvalid),
        .tready     (dut.intel_vvp_tpg_0_axi4s_vid_out_tready), 
        .tlast      (dut.intel_vvp_tpg_0_axi4s_vid_out_tlast),
        .tuser      (dut.intel_vvp_tpg_0_axi4s_vid_out_tuser),
    ...
    color_space dut (
        ...
        .intel_vvp_csc_0_axi4s_vid_out_tdata  (m_axis_tdata),
        .intel_vvp_csc_0_axi4s_vid_out_tvalid (m_axis_tvalid),
        .intel_vvp_csc_0_axi4s_vid_out_tready (m_axis_tready),
        .intel_vvp_csc_0_axi4s_vid_out_tlast  (m_axis_tlast),
        .intel_vvp_csc_0_axi4s_vid_out_tuser  (m_axis_tuser)
    );
