...
alias com {
  ...
  vlog "$QSYS_SIMDIR/submodules/system_alt_vip_crs_0.vo"     -work alt_vip_crs_0 
  vlog "$QSYS_SIMDIR/submodules/system_alt_vip_tpg_0.vo"     -work alt_vip_tpg_0 
...
alias elab {
  echo "\[exec\] elab"
  vsim +access +r  -t ps -L work -L rst_controller -L alt_vip_crs_0 -L alt_vip_tpg_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L rst_controller -L alt_vip_crs_0 -L alt_vip_tpg_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
