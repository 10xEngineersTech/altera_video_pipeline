...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog "$QSYS_SIMDIR/submodules/system_alt_vip_crs_0.vo"     -work alt_vip_crs_0  -cdslib ./cds_libs/alt_vip_crs_0.cds.lib 
  ncvlog "$QSYS_SIMDIR/submodules/system_alt_vip_tpg_0.vo"     -work alt_vip_tpg_0  -cdslib ./cds_libs/alt_vip_tpg_0.cds.lib 
