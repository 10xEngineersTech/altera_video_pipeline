...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L rst_controller -L alt_vip_crs_0 -L alt_vip_tpg_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
