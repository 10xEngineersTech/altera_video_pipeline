...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k "$QSYS_SIMDIR/submodules/system_alt_vip_crs_0.vo"     -work alt_vip_crs_0 
  vlogan +v2k "$QSYS_SIMDIR/submodules/system_alt_vip_tpg_0.vo"     -work alt_vip_tpg_0 
