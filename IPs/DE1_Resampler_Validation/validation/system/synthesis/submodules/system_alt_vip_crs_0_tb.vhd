...
entity system_alt_vip_crs_0_tb is
end entity system_alt_vip_crs_0_tb;

architecture rtl of system_alt_vip_crs_0_tb is
	...
	component system_alt_vip_crs_0 is
		generic (
	...
	end component system_alt_vip_crs_0;
...
begin
	...
	dut : component system_alt_vip_crs_0
		generic map (
			IN_CHANNELS_IN_PAR  => 1,
			OUT_CHANNELS_IN_PAR => 1,
			PARAMETERISATION    => "<chromaResamplerParams><CRS_NAME>chroma_resampler</CRS_NAME><CRS_BPS>8</CRS_BPS><CRS_WIDTH>1920</CRS_WIDTH><CRS_HEIGHT>1080</CRS_HEIGHT><CRS_PARALLEL_MODE>false</CRS_PARALLEL_MODE><CRS_RESAMPLING><FORMAT><IN>444</IN><OUT>422</OUT></FORMAT><COSITING><V>true</V><H>true</H></COSITING></CRS_RESAMPLING><CRS_ALGORITHM><V><NAME>INTERPOLATION_1D_NEAREST_NEIGHBOUR</NAME><LUMA_ADAPTIVE>false</LUMA_ADAPTIVE></V><H><NAME>INTERPOLATION_1D_NEAREST_NEIGHBOUR</NAME><LUMA_ADAPTIVE>true</LUMA_ADAPTIVE></H></CRS_ALGORITHM></chromaResamplerParams>",
...
end architecture rtl; -- of system_alt_vip_crs_0_tb
