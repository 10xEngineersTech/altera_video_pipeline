...
# ACDS 13.0sp1 232 linux 2026.06.17.17:57:54
...
ensure_lib                            ./libraries/alt_vip_crs_0/             
vmap       alt_vip_crs_0              ./libraries/alt_vip_crs_0/             
...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L altera_avalon_vip_pkgs_lib -L rst_controller -L alt_vip_crs_0 -L alt_vip_tpg_0 -L system_inst_reset_bfm -L system_inst_clk_bfm -L system_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L altera_avalon_vip_pkgs_lib -L rst_controller -L alt_vip_crs_0 -L alt_vip_tpg_0 -L system_inst_reset_bfm -L system_inst_clk_bfm -L system_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
