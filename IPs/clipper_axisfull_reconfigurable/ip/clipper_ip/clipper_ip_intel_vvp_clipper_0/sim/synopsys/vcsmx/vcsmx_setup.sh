...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QUARTUS_SIM_LIB_DIR/cyclone10gx_atoms.v"                      -work cyclone10gx_ver     
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QUARTUS_SIM_LIB_DIR/synopsys/cyclone10gx_atoms_ncrypt.v"      -work cyclone10gx_ver     
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QUARTUS_SIM_LIB_DIR/synopsys/cyclone10gx_hip_atoms_ncrypt.v"  -work cyclone10gx_hip_ver 
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QUARTUS_SIM_LIB_DIR/cyclone10gx_hip_atoms.v"                  -work cyclone10gx_hip_ver 
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QUARTUS_SIM_LIB_DIR/synopsys/cyclone10gx_hssi_atoms_ncrypt.v" -work cyclone10gx_hssi_ver
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QUARTUS_SIM_LIB_DIR/cyclone10gx_hssi_atoms.v"                 -work cyclone10gx_hssi_ver
fi
