...
# ACDS 25.1.1 125 linux 2026.05.05.12:30:34
...
#     clipper_ip_intel_vvp_clipper_0
# 
...
# ----------------------------------------
# If clipper_ip_intel_vvp_clipper_0 is one of several IP cores in your
...
TOP_LEVEL_NAME="clipper_ip_intel_vvp_clipper_0.clipper_ip_intel_vvp_clipper_0"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/mnt/ssd2/Quartus_Setup_Installation/quartus/"
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [clipper_ip_intel_vvp_clipper_0::get_elab_options $SIMULATOR_TOOL_BITNESS]
...
device_libraries='lpm_ver sgate_ver altera_ver altera_mf_ver altera_lnsim_ver cyclone10gx_ver cyclone10gx_hip_ver cyclone10gx_hssi_ver '
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set memory_files [concat $memory_files [clipper_ip_intel_vvp_clipper_0::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  xmvlog -zlib 1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QUARTUS_SIM_LIB_DIR/cyclone10gx_atoms.v"                     -work cyclone10gx_ver     
  xmvlog -zlib 1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QUARTUS_SIM_LIB_DIR/cadence/cyclone10gx_atoms_ncrypt.v"      -work cyclone10gx_ver     
  xmvlog -zlib 1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QUARTUS_SIM_LIB_DIR/cadence/cyclone10gx_hip_atoms_ncrypt.v"  -work cyclone10gx_hip_ver 
  xmvlog -zlib 1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QUARTUS_SIM_LIB_DIR/cyclone10gx_hip_atoms.v"                 -work cyclone10gx_hip_ver 
  xmvlog -zlib 1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QUARTUS_SIM_LIB_DIR/cadence/cyclone10gx_hssi_atoms_ncrypt.v" -work cyclone10gx_hssi_ver
  xmvlog -zlib 1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QUARTUS_SIM_LIB_DIR/cyclone10gx_hssi_atoms.v"                -work cyclone10gx_hssi_ver
fi
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [clipper_ip_intel_vvp_clipper_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [clipper_ip_intel_vvp_clipper_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
...
set libraries [dict create]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set libraries [dict merge $libraries [clipper_ip_intel_vvp_clipper_0::get_dpi_libraries "$QSYS_SIMDIR"]]
