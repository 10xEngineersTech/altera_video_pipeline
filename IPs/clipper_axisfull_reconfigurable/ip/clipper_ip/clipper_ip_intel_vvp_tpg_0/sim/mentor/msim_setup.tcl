...
alias com {
  ...
  set common_design_files [dict values [clipper_ip_intel_vvp_tpg_0::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [clipper_ip_intel_vvp_tpg_0::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
