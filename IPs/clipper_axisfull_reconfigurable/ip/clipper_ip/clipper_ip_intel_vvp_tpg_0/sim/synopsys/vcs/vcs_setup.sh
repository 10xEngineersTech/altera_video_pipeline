...
TOP_LEVEL_NAME="clipper_ip_intel_vvp_tpg_0"
QSYS_SIMDIR="./../../"
...
source $QSYS_SIMDIR/common/vcs_files.tcl
set files [dict merge $files [clipper_ip_intel_vvp_tpg_0::get_common_design_files "$QSYS_SIMDIR"]]
...
set QUARTUS_INSTALL_DIR [lindex $argv 2]
source $QSYS_SIMDIR/common/vcs_files.tcl
if {[catch {clipper_ip_intel_vvp_tpg_0::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"} errorMsg]} {
 puts "Catch error: $errorMsg"
 exit 1 
}
set files [dict create]
set files [dict merge $files [clipper_ip_intel_vvp_tpg_0::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
