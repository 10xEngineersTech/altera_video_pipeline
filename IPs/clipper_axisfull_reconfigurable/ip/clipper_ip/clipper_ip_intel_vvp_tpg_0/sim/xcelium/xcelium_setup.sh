...
# ACDS 25.1.1 125 linux 2026.05.05.12:30:33
...
# ----------------------------------------
# If clipper_ip_intel_vvp_tpg_0 is one of several IP cores in your
...
TOP_LEVEL_NAME="clipper_ip_intel_vvp_tpg_0.clipper_ip_intel_vvp_tpg_0"
QSYS_SIMDIR="./../"
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [clipper_ip_intel_vvp_tpg_0::get_elab_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set memory_files [concat $memory_files [clipper_ip_intel_vvp_tpg_0::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [clipper_ip_intel_vvp_tpg_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [clipper_ip_intel_vvp_tpg_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
...
set libraries [dict create]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set libraries [dict merge $libraries [clipper_ip_intel_vvp_tpg_0::get_dpi_libraries "$QSYS_SIMDIR"]]
