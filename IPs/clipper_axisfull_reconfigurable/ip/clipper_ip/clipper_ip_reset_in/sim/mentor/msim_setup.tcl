...
# ----------------------------------------
# If clipper_ip_reset_in is one of several IP cores in your
...
# ----------------------------------------
# ACDS 25.1 129 linux 2026.04.23.23:15:19
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "clipper_ip_reset_in.clipper_ip_reset_in"
}
...
append ELAB_OPTIONS [subst [clipper_ip_reset_in::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [clipper_ip_reset_in::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [clipper_ip_reset_in::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
  ...
  set normalized_src [clipper_ip_reset_in::normalize_path "$file"]
  set normalized_dest [clipper_ip_reset_in::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [clipper_ip_reset_in::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [clipper_ip_reset_in::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [clipper_ip_reset_in::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [clipper_ip_reset_in::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
