...
module color_space_intel_vvp_csc_0_intel_vvp_ro_reg_servicer_2441_utdfbgq
   (  clk,
      rst,
   ...
   localparam integer P_RO_PARAMS [0 : P_RO_REG_COUNT-1] =  '{ P_VID_PID, P_VERSION_NUMBER, 0, 1, 8, 8, 21, 1, 10, 1, 10, 0, 1 };
