...
namespace eval pl_sys_intel_vvp_dil_0 {
  proc get_design_libraries {} {
    ...
    dict set libraries pl_sys_intel_vvp_dil_0                 1
    return $libraries
  }
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_vvp_dil_2451/sim/pl_sys_intel_vvp_dil_0_intel_vvp_dil_2451_zskkody.v"]\"  -work intel_vvp_dil_2451"                                                                        
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/pl_sys_intel_vvp_dil_0.v"]\"  -work pl_sys_intel_vvp_dil_0"                                                                                                                         
    return $design_files
  }
