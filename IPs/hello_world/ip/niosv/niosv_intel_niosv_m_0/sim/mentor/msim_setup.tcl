...
# ----------------------------------------
# If niosv_intel_niosv_m_0 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 25.1.1 125 linux 2026.06.30.13:08:01
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "niosv_intel_niosv_m_0.niosv_intel_niosv_m_0"
}
...
append ELAB_OPTIONS [subst [niosv_intel_niosv_m_0::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [niosv_intel_niosv_m_0::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [niosv_intel_niosv_m_0::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
  ...
  set normalized_src [niosv_intel_niosv_m_0::normalize_path "$file"]
  set normalized_dest [niosv_intel_niosv_m_0::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [niosv_intel_niosv_m_0::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [niosv_intel_niosv_m_0::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [niosv_intel_niosv_m_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [niosv_intel_niosv_m_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
