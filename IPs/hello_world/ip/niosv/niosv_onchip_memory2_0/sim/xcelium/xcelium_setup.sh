...
# ACDS 25.1.1 125 linux 2026.06.24.12:23:36
...
# ----------------------------------------
# If niosv_onchip_memory2_0 is one of several IP cores in your
...
TOP_LEVEL_NAME="niosv_onchip_memory2_0.niosv_onchip_memory2_0"
QSYS_SIMDIR="./../"
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [niosv_onchip_memory2_0::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [niosv_onchip_memory2_0::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [niosv_onchip_memory2_0::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set libraries [dict merge $libraries [niosv_onchip_memory2_0::get_design_libraries]]
...
device_libraries='lpm_ver sgate_ver altera_ver altera_mf_ver altera_lnsim_ver tennm_ver tennm_hvio_ver tennm_sm_hps_ver tennm_agilex5_io96_ver tennm_agilex5_hssi_a_ver '
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set memory_files [concat $memory_files [niosv_onchip_memory2_0::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$DEVICES_SIM_LIB_DIR/tennm_hvio.sv"                  -work tennm_hvio_ver          
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$DEVICES_SIM_LIB_DIR/tennm_hvio_ncrypt.sv"           -work tennm_hvio_ver          
  ...
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$DEVICES_SIM_LIB_DIR/tennm_agilex5_io96.sv"          -work tennm_agilex5_io96_ver  
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$DEVICES_SIM_LIB_DIR/tennm_agilex5_io96_ncrypt.sv"   -work tennm_agilex5_io96_ver  
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$DEVICES_SIM_LIB_DIR/tennm_agilex5_hssi_a.sv"        -work tennm_agilex5_hssi_a_ver
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$DEVICES_SIM_LIB_DIR/tennm_agilex5_hssi_a_ncrypt.sv" -work tennm_agilex5_hssi_a_ver
fi
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [niosv_onchip_memory2_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [niosv_onchip_memory2_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
...
set libraries [dict create]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set libraries [dict merge $libraries [niosv_onchip_memory2_0::get_dpi_libraries "$QSYS_SIMDIR"]]
