...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "system_clock_in.system_clock_in"
}
...
append ELAB_OPTIONS [subst [system_clock_in::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [system_clock_in::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set normalized_src [system_clock_in::normalize_path "$file"]
  set normalized_dest [system_clock_in::normalize_path "$dest_file"]
...
set design_libraries [dict merge $design_libraries [system_clock_in::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [system_clock_in::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [system_clock_in::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
