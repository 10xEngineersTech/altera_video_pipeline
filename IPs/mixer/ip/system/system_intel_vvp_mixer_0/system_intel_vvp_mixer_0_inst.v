	system_intel_vvp_mixer_0 u0 (
		...
		.axi4s_vid_0_in_tdata              (_connected_to_axi4s_vid_0_in_tdata_),              //   input,  width = 24,      axi4s_vid_0_in.tdata
		.axi4s_vid_0_in_tvalid             (_connected_to_axi4s_vid_0_in_tvalid_),             //   input,   width = 1,                    .tvalid
		.axi4s_vid_0_in_tready             (_connected_to_axi4s_vid_0_in_tready_),             //  output,   width = 1,                    .tready
		.axi4s_vid_0_in_tlast              (_connected_to_axi4s_vid_0_in_tlast_),              //   input,   width = 1,                    .tlast
		.axi4s_vid_0_in_tuser              (_connected_to_axi4s_vid_0_in_tuser_),              //   input,   width = 3,                    .tuser
		...
		.axi4s_vid_1_in_tdata              (_connected_to_axi4s_vid_1_in_tdata_),              //   input,  width = 24,      axi4s_vid_1_in.tdata
		.axi4s_vid_1_in_tvalid             (_connected_to_axi4s_vid_1_in_tvalid_),             //   input,   width = 1,                    .tvalid
		.axi4s_vid_1_in_tready             (_connected_to_axi4s_vid_1_in_tready_),             //  output,   width = 1,                    .tready
		.axi4s_vid_1_in_tlast              (_connected_to_axi4s_vid_1_in_tlast_),              //   input,   width = 1,                    .tlast
		.axi4s_vid_1_in_tuser              (_connected_to_axi4s_vid_1_in_tuser_),              //   input,   width = 3,                    .tuser
		.av_mm_control_agent_address       (_connected_to_av_mm_control_agent_address_),       //   input,   width = 8, av_mm_control_agent.address
