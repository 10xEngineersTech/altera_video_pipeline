...
module system_intel_vvp_mixer_1 (
	...
	system_intel_vvp_mixer_1_intel_vvp_mixer_2451_snnu3si intel_vvp_mixer_0 (
		...
		.axi4s_vid_0_in_tdata              (axi4s_vid_0_in_tdata),              //   input,  width = 24,      axi4s_vid_0_in.tdata
		.axi4s_vid_0_in_tvalid             (axi4s_vid_0_in_tvalid),             //   input,   width = 1,                    .tvalid
		.axi4s_vid_0_in_tready             (axi4s_vid_0_in_tready),             //  output,   width = 1,                    .tready
		.axi4s_vid_0_in_tlast              (axi4s_vid_0_in_tlast),              //   input,   width = 1,                    .tlast
		.axi4s_vid_0_in_tuser              (axi4s_vid_0_in_tuser),              //   input,   width = 3,                    .tuser
		...
		.axi4s_vid_1_in_tdata              (axi4s_vid_1_in_tdata),              //   input,  width = 24,      axi4s_vid_1_in.tdata
		.axi4s_vid_1_in_tvalid             (axi4s_vid_1_in_tvalid),             //   input,   width = 1,                    .tvalid
		.axi4s_vid_1_in_tready             (axi4s_vid_1_in_tready),             //  output,   width = 1,                    .tready
		.axi4s_vid_1_in_tlast              (axi4s_vid_1_in_tlast),              //   input,   width = 1,                    .tlast
		.axi4s_vid_1_in_tuser              (axi4s_vid_1_in_tuser),              //   input,   width = 3,                    .tuser
		.axi4s_vid_2_in_tdata              (axi4s_vid_2_in_tdata),              //   input,  width = 24,      axi4s_vid_2_in.tdata
		.axi4s_vid_2_in_tvalid             (axi4s_vid_2_in_tvalid),             //   input,   width = 1,                    .tvalid
		.axi4s_vid_2_in_tready             (axi4s_vid_2_in_tready),             //  output,   width = 1,                    .tready
		.axi4s_vid_2_in_tlast              (axi4s_vid_2_in_tlast),              //   input,   width = 1,                    .tlast
		.axi4s_vid_2_in_tuser              (axi4s_vid_2_in_tuser),              //   input,   width = 3,                    .tuser
		.axi4s_vid_3_in_tdata              (axi4s_vid_3_in_tdata),              //   input,  width = 24,      axi4s_vid_3_in.tdata
		.axi4s_vid_3_in_tvalid             (axi4s_vid_3_in_tvalid),             //   input,   width = 1,                    .tvalid
		.axi4s_vid_3_in_tready             (axi4s_vid_3_in_tready),             //  output,   width = 1,                    .tready
		.axi4s_vid_3_in_tlast              (axi4s_vid_3_in_tlast),              //   input,   width = 1,                    .tlast
		.axi4s_vid_3_in_tuser              (axi4s_vid_3_in_tuser),              //   input,   width = 3,                    .tuser
		.axi4s_vid_4_in_tdata              (axi4s_vid_4_in_tdata),              //   input,  width = 24,      axi4s_vid_4_in.tdata
		.axi4s_vid_4_in_tvalid             (axi4s_vid_4_in_tvalid),             //   input,   width = 1,                    .tvalid
		.axi4s_vid_4_in_tready             (axi4s_vid_4_in_tready),             //  output,   width = 1,                    .tready
		.axi4s_vid_4_in_tlast              (axi4s_vid_4_in_tlast),              //   input,   width = 1,                    .tlast
		.axi4s_vid_4_in_tuser              (axi4s_vid_4_in_tuser),              //   input,   width = 3,                    .tuser
		.axi4s_vid_5_in_tdata              (axi4s_vid_5_in_tdata),              //   input,  width = 24,      axi4s_vid_5_in.tdata
		.axi4s_vid_5_in_tvalid             (axi4s_vid_5_in_tvalid),             //   input,   width = 1,                    .tvalid
		.axi4s_vid_5_in_tready             (axi4s_vid_5_in_tready),             //  output,   width = 1,                    .tready
		.axi4s_vid_5_in_tlast              (axi4s_vid_5_in_tlast),              //   input,   width = 1,                    .tlast
		.axi4s_vid_5_in_tuser              (axi4s_vid_5_in_tuser),              //   input,   width = 3,                    .tuser
		.axi4s_vid_6_in_tdata              (axi4s_vid_6_in_tdata),              //   input,  width = 24,      axi4s_vid_6_in.tdata
		.axi4s_vid_6_in_tvalid             (axi4s_vid_6_in_tvalid),             //   input,   width = 1,                    .tvalid
		.axi4s_vid_6_in_tready             (axi4s_vid_6_in_tready),             //  output,   width = 1,                    .tready
		.axi4s_vid_6_in_tlast              (axi4s_vid_6_in_tlast),              //   input,   width = 1,                    .tlast
		.axi4s_vid_6_in_tuser              (axi4s_vid_6_in_tuser),              //   input,   width = 3,                    .tuser
		.axi4s_vid_7_in_tdata              (axi4s_vid_7_in_tdata),              //   input,  width = 24,      axi4s_vid_7_in.tdata
		.axi4s_vid_7_in_tvalid             (axi4s_vid_7_in_tvalid),             //   input,   width = 1,                    .tvalid
		.axi4s_vid_7_in_tready             (axi4s_vid_7_in_tready),             //  output,   width = 1,                    .tready
		.axi4s_vid_7_in_tlast              (axi4s_vid_7_in_tlast),              //   input,   width = 1,                    .tlast
		.axi4s_vid_7_in_tuser              (axi4s_vid_7_in_tuser),              //   input,   width = 3,                    .tuser
