...
namespace eval system_intel_vvp_tpg_0 {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_vvp_ro_reg_servicer_2441/sim/system_intel_vvp_tpg_0_intel_vvp_ro_reg_servicer_2441_xz5geqq.sv"]\" -L altera_common_sv_packages -work intel_vvp_ro_reg_servicer_2441"               
    ...
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_merlin_master_translator_193/sim/system_intel_vvp_tpg_0_altera_merlin_master_translator_193_lgcew2q.sv"]\" -L altera_common_sv_packages -work altera_merlin_master_translator_193"
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_merlin_slave_translator_191/sim/system_intel_vvp_tpg_0_altera_merlin_slave_translator_191_xg7rzxi.sv"]\" -L altera_common_sv_packages -work altera_merlin_slave_translator_191"   
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_mm_interconnect_1920/sim/system_intel_vvp_tpg_0_altera_mm_interconnect_1920_epi4vay.v"]\"  -work altera_mm_interconnect_1920"                                                         
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_vvp_slave_front_end_2441/sim/system_intel_vvp_tpg_0_intel_vvp_slave_front_end_2441_witiuya.v"]\"  -work intel_vvp_slave_front_end_2441"                                                
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_mm_interconnect_1920/sim/system_intel_vvp_tpg_0_altera_mm_interconnect_1920_vevxpda.v"]\"  -work altera_mm_interconnect_1920"                                                         
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_vvp_tpg_2451/sim/system_intel_vvp_tpg_0_intel_vvp_tpg_2451_fnvtpvy.v"]\"  -work intel_vvp_tpg_2451"                                                                                    
