...
TOP_LEVEL_NAME="system_intel_vvp_tpg_4.system_intel_vvp_tpg_4"
QSYS_SIMDIR="./../"
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [system_intel_vvp_tpg_4::get_elab_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [system_intel_vvp_tpg_4::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [system_intel_vvp_tpg_4::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
