...
alias com {
  ...
  set common_design_files [dict values [system_intel_vvp_tpg_6::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [system_intel_vvp_tpg_6::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
