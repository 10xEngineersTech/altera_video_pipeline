...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "system.system"
}
...
append ELAB_OPTIONS [subst [system::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [system::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set normalized_src [system::normalize_path "$file"]
  set normalized_dest [system::normalize_path "$dest_file"]
...
set logical_libraries [list "work" "work_lib" "lpm_ver" "sgate_ver" "altera_ver" "altera_mf_ver" "altera_lnsim_ver" "tennm_ver" "tennm_hvio_ver" "tennm_sm_hps_ver" "tennm_agilex5_io96_ver" "tennm_agilex5_hssi_a_ver" "lpm" "sgate" "altera" "altera_mf" "altera_lnsim" "tennm" "tennm_hvio" "tennm_sm_hps" "tennm_agilex5_io96" "tennm_agilex5_hssi_a"]
...
if { $PRECOMP_DEVICE_LIB_FILE eq "" } {
  ...
  ensure_lib                          ./libraries/tennm_hvio              
  vmap       tennm_hvio               ./libraries/tennm_hvio              
  ensure_lib                          ./libraries/tennm_sm_hps            
  vmap       tennm_sm_hps             ./libraries/tennm_sm_hps            
  ensure_lib                          ./libraries/tennm_agilex5_io96      
  vmap       tennm_agilex5_io96       ./libraries/tennm_agilex5_io96      
  ensure_lib                          ./libraries/tennm_agilex5_hssi_a    
  vmap       tennm_agilex5_hssi_a     ./libraries/tennm_agilex5_hssi_a    
} else {
  vmap -link $PRECOMP_DEVICE_LIB_FILE
}
set design_libraries [dict create]
set design_libraries [dict merge $design_libraries [system::get_design_libraries]]
...
alias dev_com {
  ...
  if { $PRECOMP_DEVICE_LIB_FILE eq "" } {
    ...
    eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                    "$DEVICES_SIM_LIB_DIR/tennm_hvio.sv"                    -work tennm_hvio_ver          
    eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                    "$DEVICES_SIM_LIB_DIR/tennm_hvio_ncrypt.sv"             -work tennm_hvio_ver          
    ...
    eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                    "$DEVICES_SIM_LIB_DIR/tennm_agilex5_io96.sv"            -work tennm_agilex5_io96_ver  
    eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                    "$DEVICES_SIM_LIB_DIR/tennm_agilex5_io96_ncrypt.sv"     -work tennm_agilex5_io96_ver  
    eval  vlog  -err VCP2675 W1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                    "$DEVICES_SIM_LIB_DIR/tennm_agilex5_hssi_a.sv"          -work tennm_agilex5_hssi_a_ver
    eval  vlog  -err VCP2675 W1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                    "$DEVICES_SIM_LIB_DIR/tennm_agilex5_hssi_a_ncrypt.sv"   -work tennm_agilex5_hssi_a_ver
    ...
    eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                    "$DEVICES_SIM_LIB_DIR/tennm_hvio.sv"                    -work tennm_hvio              
    eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                    "$DEVICES_SIM_LIB_DIR/tennm_hvio_ncrypt.sv"             -work tennm_hvio              
    ...
    eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                    "$DEVICES_SIM_LIB_DIR/tennm_agilex5_io96.sv"            -work tennm_agilex5_io96      
    eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                    "$DEVICES_SIM_LIB_DIR/tennm_agilex5_io96_ncrypt.sv"     -work tennm_agilex5_io96      
    eval  vlog  -err VCP2675 W1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                    "$DEVICES_SIM_LIB_DIR/tennm_agilex5_hssi_a.sv"          -work tennm_agilex5_hssi_a    
    eval  vlog  -err VCP2675 W1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                    "$DEVICES_SIM_LIB_DIR/tennm_agilex5_hssi_a_ncrypt.sv"   -work tennm_agilex5_hssi_a    
  }
