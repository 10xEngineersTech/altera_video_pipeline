source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_mixer_1/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_reset_in/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_tpg_8/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_tpg_2/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_tpg_3/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_tpg_9/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_tpg_4/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_tpg_7/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_clock_in/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_tpg_5/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_tpg_6/sim/common/modelsim_files.tcl]
...
namespace eval system {
  ...
  proc get_common_design_files {QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [system_intel_vvp_mixer_1::get_common_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_mixer_1/sim/"]]
    ...
    set design_files [dict merge $design_files [system_intel_vvp_tpg_8::get_common_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_tpg_8/sim/"]]
    set design_files [dict merge $design_files [system_intel_vvp_tpg_2::get_common_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_tpg_2/sim/"]]
    set design_files [dict merge $design_files [system_intel_vvp_tpg_3::get_common_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_tpg_3/sim/"]]
    set design_files [dict merge $design_files [system_intel_vvp_tpg_9::get_common_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_tpg_9/sim/"]]
    set design_files [dict merge $design_files [system_intel_vvp_tpg_4::get_common_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_tpg_4/sim/"]]
    set design_files [dict merge $design_files [system_intel_vvp_tpg_7::get_common_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_tpg_7/sim/"]]
    ...
    set design_files [dict merge $design_files [system_intel_vvp_tpg_5::get_common_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_tpg_5/sim/"]]
    set design_files [dict merge $design_files [system_intel_vvp_tpg_6::get_common_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_tpg_6/sim/"]]
    return $design_files
  }
  
  proc get_design_files {QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    set design_files [list]
    set design_files [concat $design_files [system_intel_vvp_mixer_1::get_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_mixer_1/sim/" "$QUARTUS_INSTALL_DIR"]]
    ...
    set design_files [concat $design_files [system_intel_vvp_tpg_8::get_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_tpg_8/sim/" "$QUARTUS_INSTALL_DIR"]]
    set design_files [concat $design_files [system_intel_vvp_tpg_2::get_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_tpg_2/sim/" "$QUARTUS_INSTALL_DIR"]]
    set design_files [concat $design_files [system_intel_vvp_tpg_3::get_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_tpg_3/sim/" "$QUARTUS_INSTALL_DIR"]]
    set design_files [concat $design_files [system_intel_vvp_tpg_9::get_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_tpg_9/sim/" "$QUARTUS_INSTALL_DIR"]]
    set design_files [concat $design_files [system_intel_vvp_tpg_4::get_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_tpg_4/sim/" "$QUARTUS_INSTALL_DIR"]]
    set design_files [concat $design_files [system_intel_vvp_tpg_7::get_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_tpg_7/sim/" "$QUARTUS_INSTALL_DIR"]]
    ...
    set design_files [concat $design_files [system_intel_vvp_tpg_5::get_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_tpg_5/sim/" "$QUARTUS_INSTALL_DIR"]]
    set design_files [concat $design_files [system_intel_vvp_tpg_6::get_design_files "$QSYS_SIMDIR/../../ip/system/system_intel_vvp_tpg_6/sim/" "$QUARTUS_INSTALL_DIR"]]
