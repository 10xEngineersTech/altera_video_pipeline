source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_mixer_1/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_reset_in/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_tpg_8/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_tpg_2/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_tpg_3/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_tpg_9/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_tpg_4/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_tpg_7/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_clock_in/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_tpg_5/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system/system_intel_vvp_tpg_6/sim/common/xcelium_files.tcl]
...
namespace eval system {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "xmvlog -zlib 1 -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"$QSYS_SIMDIR/system.v\"  -work system"                                                                                                                            
    return $design_files
  }
