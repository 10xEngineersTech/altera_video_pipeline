...
namespace eval system_intel_vvp_protocol_conv_1 {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_vvp_protocol_conv_2460/sim/system_intel_vvp_protocol_conv_1_intel_vvp_protocol_conv_2460_ydxwruq.v"]\"  -work intel_vvp_protocol_conv_2460"                                
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/system_intel_vvp_protocol_conv_1.v"]\"  -work system_intel_vvp_protocol_conv_1"                                                                                                     
    return $design_files
  }
