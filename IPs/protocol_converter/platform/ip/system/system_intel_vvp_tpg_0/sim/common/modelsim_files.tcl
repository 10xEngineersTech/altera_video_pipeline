...
namespace eval system_intel_vvp_tpg_0 {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_vvp_tpg_2451/sim/system_intel_vvp_tpg_0_intel_vvp_tpg_2451_6ysywkq.v"]\"  -work intel_vvp_tpg_2451"                                                                        
