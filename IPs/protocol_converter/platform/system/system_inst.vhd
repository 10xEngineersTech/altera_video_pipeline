	component system is
		port (
			...
			intel_vvp_protocol_conv_0_av_mm_control_agent_address       : in  std_logic_vector(6 downto 0)  := (others => 'X'); -- address
			intel_vvp_protocol_conv_0_av_mm_control_agent_write         : in  std_logic                     := 'X';             -- write
			intel_vvp_protocol_conv_0_av_mm_control_agent_byteenable    : in  std_logic_vector(3 downto 0)  := (others => 'X'); -- byteenable
			intel_vvp_protocol_conv_0_av_mm_control_agent_writedata     : in  std_logic_vector(31 downto 0) := (others => 'X'); -- writedata
			intel_vvp_protocol_conv_0_av_mm_control_agent_read          : in  std_logic                     := 'X';             -- read
			intel_vvp_protocol_conv_0_av_mm_control_agent_readdata      : out std_logic_vector(31 downto 0);                    -- readdata
			intel_vvp_protocol_conv_0_av_mm_control_agent_readdatavalid : out std_logic;                                        -- readdatavalid
			intel_vvp_protocol_conv_0_av_mm_control_agent_waitrequest   : out std_logic;                                        -- waitrequest
	...
	u0 : component system
		port map (
			...
			intel_vvp_protocol_conv_0_av_mm_control_agent_address       => CONNECTED_TO_intel_vvp_protocol_conv_0_av_mm_control_agent_address,       -- intel_vvp_protocol_conv_0_av_mm_control_agent.address
			intel_vvp_protocol_conv_0_av_mm_control_agent_write         => CONNECTED_TO_intel_vvp_protocol_conv_0_av_mm_control_agent_write,         --                                              .write
			intel_vvp_protocol_conv_0_av_mm_control_agent_byteenable    => CONNECTED_TO_intel_vvp_protocol_conv_0_av_mm_control_agent_byteenable,    --                                              .byteenable
			intel_vvp_protocol_conv_0_av_mm_control_agent_writedata     => CONNECTED_TO_intel_vvp_protocol_conv_0_av_mm_control_agent_writedata,     --                                              .writedata
			intel_vvp_protocol_conv_0_av_mm_control_agent_read          => CONNECTED_TO_intel_vvp_protocol_conv_0_av_mm_control_agent_read,          --                                              .read
			intel_vvp_protocol_conv_0_av_mm_control_agent_readdata      => CONNECTED_TO_intel_vvp_protocol_conv_0_av_mm_control_agent_readdata,      --                                              .readdata
			intel_vvp_protocol_conv_0_av_mm_control_agent_readdatavalid => CONNECTED_TO_intel_vvp_protocol_conv_0_av_mm_control_agent_readdatavalid, --                                              .readdatavalid
			intel_vvp_protocol_conv_0_av_mm_control_agent_waitrequest   => CONNECTED_TO_intel_vvp_protocol_conv_0_av_mm_control_agent_waitrequest,   --                                              .waitrequest
