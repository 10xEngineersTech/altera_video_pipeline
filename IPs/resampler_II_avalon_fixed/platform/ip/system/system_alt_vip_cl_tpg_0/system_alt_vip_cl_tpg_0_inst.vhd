	component system_alt_vip_cl_tpg_0 is
		port (
			...
			dout_empty         : out std_logic_vector(1 downto 0);         -- empty
			dout_ready         : in  std_logic                     := 'X'  -- ready
		);
	end component system_alt_vip_cl_tpg_0;

	u0 : component system_alt_vip_cl_tpg_0
		port map (
