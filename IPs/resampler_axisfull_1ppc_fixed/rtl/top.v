...
module top (
    ...
    wire [23:0] tpg_to_crs_tdata_raw;
    wire [23:0] tpg_to_crs_tdata;
    wire        tpg_to_crs_tvalid;
    wire        tpg_to_crs_tready;
    wire        tpg_to_crs_tlast;
    wire [2:0]  tpg_to_crs_tuser_raw;
    wire [2:0]  tpg_to_crs_tuser;

    // Force tuser[2] to zero and zero out data during reset
    assign tpg_to_crs_tuser = {1'b0, tpg_to_crs_tuser_raw[1:0]};
    assign tpg_to_crs_tdata = reset_reset ? 24'b0 : tpg_to_crs_tdata_raw;

    // Resampler Out (Exported)
    wire [23:0] crs_out_tdata_raw;
    wire [23:0] crs_out_tdata;
    wire        crs_out_tvalid;
    wire        crs_out_tready;
    wire        crs_out_tlast;
    wire [2:0]  crs_out_tuser_raw;
    wire [2:0]  crs_out_tuser;

    // Force tuser[2] to zero and zero out data during reset
    assign crs_out_tuser = {1'b0, crs_out_tuser_raw[1:0]};
    assign crs_out_tdata = reset_reset ? 24'b0 : crs_out_tdata_raw;
    ...
    system u_dut (
        ...
        // TPG Out
        .intel_vvp_tpg_0_axi4s_vid_out_tdata               (tpg_to_crs_tdata_raw),
        ...
        .intel_vvp_tpg_0_axi4s_vid_out_tuser               (tpg_to_crs_tuser_raw),
        ...
        // Resampler Out
        .intel_vvp_crs_0_axi4s_vid_out_tdata               (crs_out_tdata_raw),
        ...
        .intel_vvp_crs_0_axi4s_vid_out_tuser               (crs_out_tuser_raw),
