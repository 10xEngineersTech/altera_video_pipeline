...
module testbench;
    ...
    // =========================================================================
    localparam SCALER_IN_W  = 20;   // Scaler input  pixels per line  (from TPG)
    localparam SCALER_IN_H  = 10;   // Scaler input  lines  per frame (from TPG)
    localparam SCALER_OUT_W = 10;   // Scaler output pixels per line  (checker expects this)
    localparam SCALER_OUT_H =  5;   // Scaler output lines  per frame (checker expects this)
    ...
    localparam PASS_FRAMES   = 8;           // frames to verify before declaring pass
