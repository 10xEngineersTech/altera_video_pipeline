...
namespace eval pipeline_intel_vvp_crs_0 {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_vvp_crs_h_2451/sim/pipeline_intel_vvp_crs_0_intel_vvp_crs_h_2451_7uuv3hi.v"]\"  -work intel_vvp_crs_h_2451"                                                                
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_vvp_crs_2451/sim/pipeline_intel_vvp_crs_0_intel_vvp_crs_2451_bzwm74i.v"]\"  -work intel_vvp_crs_2451"                                                                      
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/pipeline_intel_vvp_crs_0.v"]\"  -work pipeline_intel_vvp_crs_0"                                                                                                                     
    return $design_files
  }
