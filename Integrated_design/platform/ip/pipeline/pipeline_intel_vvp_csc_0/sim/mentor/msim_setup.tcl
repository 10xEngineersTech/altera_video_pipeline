...
alias com {
  ...
  set common_design_files [dict values [pipeline_intel_vvp_csc_0::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [pipeline_intel_vvp_csc_0::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
