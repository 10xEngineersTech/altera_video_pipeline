...
module pipeline_intel_vvp_pipeline2_0_altera_merlin_axi_slave_ni_19122_rzns46y
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    pipeline_intel_vvp_pipeline2_0_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_19122_nscfrfy #(
        .SYMBOLS_PER_BEAT    (1),
...
generate
   ...
   if(ENABLE_OOO ==1 && REORDER_BUFFER == 0)begin
       ...
       pipeline_intel_vvp_pipeline2_0_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19122_76nbkei #(
             .SYMBOLS_PER_BEAT (1),
