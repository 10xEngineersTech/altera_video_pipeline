...
module pipeline_intel_vvp_pipeline2_0_altera_merlin_axi_slave_ni_19122_ehw7rrq
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    pipeline_intel_vvp_pipeline2_0_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_19122_v3v3q4i #(
        .SYMBOLS_PER_BEAT    (1),
...
generate 
   if (ENABLE_OOO == 1) begin
    ...
    pipeline_intel_vvp_pipeline2_0_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19122_k2wpo7a #(
      .SYMBOLS_PER_BEAT (1),
    ...
    pipeline_intel_vvp_pipeline2_0_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19122_dfqgfyi #(
      .SYMBOLS_PER_BEAT (1),
...
generate
   ...
   if(ENABLE_OOO ==1 && REORDER_BUFFER == 0)begin
       ...
       pipeline_intel_vvp_pipeline2_0_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19122_bcejyqa #(
             .SYMBOLS_PER_BEAT (1),
