// pipeline_intel_vvp_pipeline2_0_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19122_4ksnpba.v

// Generated using ACDS version 25.1.1 125

`timescale 1 ps / 1 ps
module pipeline_intel_vvp_pipeline2_0_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19122_4ksnpba #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 43,
		...
		input  wire [42:0] in_data,   //          .data,  Input Data port of Avalon Streaming Sink Interface
		...
		output wire [42:0] out_data   //          .data,  Output Data port of Avalon Streaming Source Interface
	);
	...
	pipeline_intel_vvp_pipeline2_0_altera_avalon_st_pipeline_stage_1930_oiupeiq #(
		...
		.in_data           (in_data),   //   input,  width = 43,          .data
		.out_ready         (out_ready), //   input,   width = 1,   source0.ready
		.out_valid         (out_valid), //  output,   width = 1,          .valid
		.out_data          (out_data),  //  output,  width = 43,          .data
