// pipeline_intel_vvp_pipeline2_0_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19122_bcejyqa.v

// Generated using ACDS version 25.1.1 125

`timescale 1 ps / 1 ps
module pipeline_intel_vvp_pipeline2_0_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19122_bcejyqa #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 444,
		...
		input  wire [443:0] in_data,           //          .data,          Input Data port of Avalon Streaming Sink Interface
		...
		output wire [443:0] out_data           //          .data,          Output Data port of Avalon Streaming Source Interface
	);

	pipeline_intel_vvp_pipeline2_0_altera_avalon_st_pipeline_stage_1930_oiupeiq #(
		...
		.in_data           (in_data),           //   input,  width = 444,          .data
		...
		.out_data          (out_data),          //  output,  width = 444,          .data
