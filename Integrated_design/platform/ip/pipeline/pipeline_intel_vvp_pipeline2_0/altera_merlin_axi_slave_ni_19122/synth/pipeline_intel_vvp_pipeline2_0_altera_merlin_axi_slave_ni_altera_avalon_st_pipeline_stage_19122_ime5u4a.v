// pipeline_intel_vvp_pipeline2_0_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19122_ime5u4a.v

// Generated using ACDS version 25.1.1 125

`timescale 1 ps / 1 ps
module pipeline_intel_vvp_pipeline2_0_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19122_ime5u4a #(
		...
		input  wire [3:0] in_data,   //          .data,  Input Data port of Avalon Streaming Sink Interface
		...
		output wire [3:0] out_data   //          .data,  Output Data port of Avalon Streaming Source Interface
	);
