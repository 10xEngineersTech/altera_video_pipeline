...
module pipeline_intel_vvp_pipeline2_0_altera_merlin_traffic_limiter_1921_mtran2q
#(
   parameter
      PKT_TRANS_POSTED           = 1,
      PKT_DEST_ID_H              = 0,
     ...
     if (REORDER) begin: fifo_dest_id_write_read_control_reorder_on
       ...
       if (ENABLE_OOO == 0 | USE_FIFO == 0) begin : REORDER_WITHOUT_FIFO_OR_INORDER_RSP
         ...
         if (ENABLE_OOO == 0) begin : REORDER_for_in_order_rsp
           ...
           pipeline_intel_vvp_pipeline2_0_altera_merlin_traffic_limiter_altera_avalon_sc_fifo_1921_yyptyti #(
                 .SYMBOLS_PER_BEAT   (1),
