...
module io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_phy_arch_fp_atom_inst_byte #(
   ...
   timeunit 1ns;
   timeprecision 1ps;
   import io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_atom_attr_byte::*;
   ...
   generate 
      if (IS_USED[ID]) begin : gen_used_byte
         tennm_byte # (
            ...
            .i_phy_sdll0_rx_d0sdlparkvalue(i_phy_sdll0_rx_d0sdlparkvalue), .i_phy_sdll1_rx_d0sdlparkvalue(i_phy_sdll1_rx_d0sdlparkvalue),
      ...
      // end else if (IS_SHADOW[ID]) begin : gen_shadow_byte
