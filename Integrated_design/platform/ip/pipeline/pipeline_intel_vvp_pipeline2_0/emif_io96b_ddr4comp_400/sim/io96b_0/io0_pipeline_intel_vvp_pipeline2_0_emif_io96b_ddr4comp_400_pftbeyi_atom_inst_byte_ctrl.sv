...
module io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_phy_arch_fp_atom_inst_byte_ctrl #(
   ...
   timeunit 1ns;
   timeprecision 1ps;
   import io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_atom_attr_byte_ctrl::*;
   ...
   generate 
      if (IS_USED[ID]) begin : gen_used_byte_ctrl
         ...
         tennm_byte_control # (
            ...
            .o_phyctrl_sdll0_rx_d0sdlparkvalue(o_phyctrl_sdll0_rx_d0sdlparkvalue), .o_phyctrl_sdll1_rx_d0sdlparkvalue(o_phyctrl_sdll1_rx_d0sdlparkvalue)
         );


      // synthesis read_comments_as_HDL on
      // end else if (IS_SHADOW[ID]) begin : gen_shadow_byte_ctrl
      //        defparam u_shadow_byte_ctrl.sim_mdelay_value_ps = 0;
      //        (* altera_attribute = {"-name IO_SHADOW_CELL ON"} *)
      //        tennm_byte_control # (
      //           .base_address                                         (BASE_ADDRESS[ID]),
      //           .lfifo_value                                          (LFIFO_VALUE[ID]),
      //           `byte_ctrl_pinX_params(0)
