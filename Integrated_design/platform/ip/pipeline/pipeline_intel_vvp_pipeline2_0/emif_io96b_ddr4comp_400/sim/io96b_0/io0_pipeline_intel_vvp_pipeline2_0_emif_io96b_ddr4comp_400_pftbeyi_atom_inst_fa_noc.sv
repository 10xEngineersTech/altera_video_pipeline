...
module io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_phy_arch_fp_atom_inst_fa_noc #(
   parameter ID = 0
) (
   ...
   import io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_atom_attr_fa_noc::*;;
