...
module io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_io96b_top #(
   ...
   localparam INTF_PA_TO_SEQ_WIDTH  = PORT_SEQ_CFG_DATA_WIDTH +
    ...
    localparam [1:0] MC_USED = { io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_atom_attr_hmc_slim::IS_USED == 1 && io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_atom_attr_hmc_slim::IS_DUMMY_SLIM == 0,
                                 io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_atom_attr_hmc_wide::IS_USED == 1};
    
    localparam LOCKSTEP_SECONDARY =  io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_atom_attr_hmc_wide::LOCKSTEP_CONFIG == "LOCKSTEP_CONFIG_SECONDARY";
   ...
   io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_phy_arch_fp_atom_inst_bufs_mem # (
   ...
   generate
      if (PHY_I3C_EN) begin : i3c
         io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_phy_arch_fp_atom_inst_bufs_i3c # (
   ...
   generate
      ...
      for (i = 0; i < NUM_BYTES_IN_IO96; ++i) begin: gen_byte_conns
         ...
         io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_phy_arch_fp_atom_inst_byte # (
            .ID(i)
         ) wrapper_byte (
         ...
         io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_phy_arch_fp_atom_inst_byte_ctrl # (
            .ID(i)
         ) wrapper_byte_ctrl (
        ...
        io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_phy_arch_fp_atom_inst_pa # (
            .ID(i)
        ) wrapper_pa (
            .hmc_to_pa (mc_to_pa), 
            .pa_to_hmc (pa_to_mc), 
        ...
        io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_phy_arch_fp_atom_inst_fa_lane # (
            .ID(i)
         ) wrapper_falane (
         ...
         if (io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_atom_attr_byte_ctrl::IS_USED[i] && io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_atom_attr_byte::IS_USED[i]) begin
   ...
   io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_phy_arch_fp_atom_inst_hmc_wide # (
      .ID(0),
   ...
   io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_phy_arch_fp_atom_inst_hmc_slim # (
      .ID(1),
      .AXI4_ADDR_WIDTH(AXI4_ADDR_WIDTH),
   ...
   io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_phy_arch_fp_atom_inst_fa_hmc # (
      .ID(0)
   ) wrapper_fahmc_wide (
   ...
   io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_phy_arch_fp_atom_inst_fa_noc # (
      .ID(0)
   ) wrapper_fanoc_wide (
   ...
   io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_phy_arch_fp_atom_inst_pll # (
   ) wrapper_pll (
      .ref_clk    (ref_clk_0),
      .rst_n      (pll_rst_n),
   ...
   io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_phy_arch_fp_atom_inst_cpa # (
   ) wrapper_cpa (
   ...
   io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_phy_arch_fp_fbr_axi_adapter_wide # (
      .PORT_AXI_AXADDR_WIDTH     (PORT_AXI_AXADDR_WIDTH    ),
      .PORT_AXI_AXBURST_WIDTH    (PORT_AXI_AXBURST_WIDTH   ),
      .PORT_AXI_AXID_WIDTH       (PORT_AXI_AXID_WIDTH      ),
      .PORT_AXI_AXLEN_WIDTH      (PORT_AXI_AXLEN_WIDTH     ),
   ...
   io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_phy_arch_fp_fbr_axi_adapter_slim # (
      .PORT_AXI_AXADDR_WIDTH     (PORT_AXI_AXADDR_WIDTH    ),
      .PORT_AXI_AXBURST_WIDTH    (PORT_AXI_AXBURST_WIDTH   ),
      .PORT_AXI_AXID_WIDTH       (PORT_AXI_AXID_WIDTH      ),
      .PORT_AXI_AXLEN_WIDTH      (PORT_AXI_AXLEN_WIDTH     ),
