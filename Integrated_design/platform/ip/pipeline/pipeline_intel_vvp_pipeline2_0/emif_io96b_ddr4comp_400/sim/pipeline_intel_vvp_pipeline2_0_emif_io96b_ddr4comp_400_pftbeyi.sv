...
module pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi #(
   ...
   generate
      begin: arch_emif_0
         if (MEM_NUM_CHANNELS_PER_IO96 == 2) begin: arch0_2ch_per_io 
            ...
            io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_io96b_top #(
      ...
      begin: arch_emif_1
         if (MEM_NUM_IO96 == 2) begin: arch1_exists
            if (MEM_NUM_CHANNELS_PER_IO96 == 2) begin: arch1_2ch_per_io 
               ...
               io1_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_io96b_top #(
                  .PHY_NOC_EN                (PHY_USE_NOC_INTF         ),
   ...
   generate 
      begin: io0
      // {{{ cal_0
      pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_emif_io96b_cal_400_7ib5isq calip_0 (
