...
module pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa #(
   ...
   generate
      begin: arch_emif_0
         if (MEM_NUM_CHANNELS_PER_IO96 == 2) begin: arch0_2ch_per_io 
            ...
            io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_io96b_top #(
      ...
      begin: arch_emif_1
         if (MEM_NUM_IO96 == 2) begin: arch1_exists
            if (MEM_NUM_CHANNELS_PER_IO96 == 2) begin: arch1_2ch_per_io 
               ...
               io1_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_io96b_top #(
                  .PHY_NOC_EN                (PHY_USE_NOC_INTF         ),
