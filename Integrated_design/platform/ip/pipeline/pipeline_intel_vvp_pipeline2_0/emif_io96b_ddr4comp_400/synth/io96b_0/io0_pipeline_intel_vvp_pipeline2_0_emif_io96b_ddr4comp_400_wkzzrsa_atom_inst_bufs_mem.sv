   ...
   `define block_unused_pins                                                                                                                                                 \
       generate                                                                                                                                                              \
          for (_pin = 0; _pin < $size(UNUSED_PINS_LOCATION_BYTE) && UNUSED_PINS_LOCATION_BYTE[_pin]!=-10'sd1 && UNUSED_PINS_LOCATION_PIN[_pin]!=-10'sd1; ++_pin) begin : g_UNUSED \
             wire pipe_out;                                                                                                                                                  \
             wire pipe_in;                                                                                                                                                   \
             (* altera_attribute = {"-name PRESERVE_FANOUT_FREE_WYSIWYG ON; -name IO_SHADOW_CELL ON"} *)                                                                     \
             tennm_ph2_io_ibuf # (                                                                                                                                           \
...
module io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_phy_arch_fp_atom_inst_bufs_mem #(
   ...
   import io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_atom_attr_pin_locations::*;
   import io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_atom_attr_bufs_mem::*;
