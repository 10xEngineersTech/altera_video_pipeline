...
module io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_phy_arch_fp_atom_inst_fa_lane #(
   ...
   timeunit 1ns;
   timeprecision 1ps;
   import io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_atom_attr_fa_c2p_lane::*;
   import io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_atom_attr_fa_p2c_lane::*;
   ...
   generate
      if (io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_atom_attr_fa_c2p_lane::IS_USED[ID])
      begin : gen_lane_c2p_fa
         tennm_lane_c2p_fabric_adaptor # (
            .fa_core_periph_clk_sel_data_mode        (io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_atom_attr_fa_c2p_lane::FA_CORE_PERIPH_CLK_SEL_DATA_MODE[ID]),
      ...
      if (io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_atom_attr_fa_p2c_lane::IS_USED[ID])
      begin : gen_lane_p2c_fa
         tennm_lane_p2c_fabric_adaptor # (
            .fa_core_periph_clk_sel_data_mode        (io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_atom_attr_fa_p2c_lane::FA_CORE_PERIPH_CLK_SEL_DATA_MODE[ID]),
   ...
   generate
   begin   
      if ((C2P_REGISTER_STAGE > 0) && (C2P_REGISTER_DELAY_PS == 100) && (io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_atom_attr_fa_c2p_lane::IS_USED[ID]))
      ...
      else if ((C2P_REGISTER_STAGE > 0) && (C2P_REGISTER_DELAY_PS == 225) && (io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_atom_attr_fa_c2p_lane::IS_USED[ID]))
      ...
      else if ((C2P_REGISTER_STAGE > 0) && (C2P_REGISTER_DELAY_PS == 350) && (io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_atom_attr_fa_c2p_lane::IS_USED[ID]))
   ...
   generate
   begin
      if ((P2C_REGISTER_STAGE > 0) && (io0_pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_atom_attr_fa_p2c_lane::IS_USED[ID]))
