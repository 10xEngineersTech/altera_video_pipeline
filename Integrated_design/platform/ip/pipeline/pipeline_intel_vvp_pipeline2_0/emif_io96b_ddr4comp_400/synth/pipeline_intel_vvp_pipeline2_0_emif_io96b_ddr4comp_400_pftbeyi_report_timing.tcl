...
source "$script_dir/pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi_report_timing_core.tcl"
set inst_id 0
...
set instances [emif_get_core_instance_list pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi]
...
foreach { ls_inst } $instances {
   ...
   if { ![dict exists $emif_lockstep_instances $inst] } {
       ...
       dict set emif_lockstep_instances $inst arch pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_pftbeyi
