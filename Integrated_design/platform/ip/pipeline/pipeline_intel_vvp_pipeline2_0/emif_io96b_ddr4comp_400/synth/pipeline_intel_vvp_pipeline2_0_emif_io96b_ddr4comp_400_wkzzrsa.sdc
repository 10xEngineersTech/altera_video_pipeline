...
source "$script_dir/pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_timing_parameters.tcl"
source "$script_dir/pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_timing_pins.tcl"
...
if { ! [ info exists pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_sdc_cache ] } {
   emif_initialize_ddr_db pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_emif_ddr_db var
   set pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_sdc_cache 1
} else {
   if { $debug } {
...
set instances [ array names pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_emif_ddr_db ]
foreach { inst } $instances {
   if { [ info exists pins ] } {
      unset pins
   }
   array set pins $pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_emif_ddr_db($inst)
...
if {  $var(LOCKSTEP_ROLE) ne "OFF" } {
    add_ddr_report_command "source [list [file join [file dirname [info script]] pipeline_intel_vvp_pipeline2_0_emif_io96b_ddr4comp_400_wkzzrsa_report_timing.tcl]]"
}
