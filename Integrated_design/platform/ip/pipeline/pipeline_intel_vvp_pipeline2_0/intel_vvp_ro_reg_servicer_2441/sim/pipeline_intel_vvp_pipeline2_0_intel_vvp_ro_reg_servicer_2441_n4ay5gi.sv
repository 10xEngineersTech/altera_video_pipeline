...
module pipeline_intel_vvp_pipeline2_0_intel_vvp_ro_reg_servicer_2441_n4ay5gi
   (  clk,
      rst,
   ...
   localparam integer P_RO_PARAMS [0 : P_RO_REG_COUNT-1] =  '{ P_VID_PID, P_VERSION_NUMBER, 1, 0, 1, 2047, 2047, 2, 1, 1, 1, 4, 16, 1, 1, 2, 10, 1, 4, 16, 1, 1, 2, 6, 0, 0, 0, 0 };
