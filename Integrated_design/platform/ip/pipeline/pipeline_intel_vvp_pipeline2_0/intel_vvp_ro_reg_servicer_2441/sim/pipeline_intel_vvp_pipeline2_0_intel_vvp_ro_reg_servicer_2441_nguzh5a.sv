...
module pipeline_intel_vvp_pipeline2_0_intel_vvp_ro_reg_servicer_2441_nguzh5a
   (  clk,
      rst,
   ...
   localparam P_RO_REG_COUNT = 5 + 2;

   localparam integer P_RO_PARAMS [0 : P_RO_REG_COUNT-1] =  '{ P_VID_PID, P_VERSION_NUMBER, 0, 0, 2048, 0, 3 };
