...
module pipeline_intel_vvp_pipeline2_0_intel_vvp_vert_scaler_algo_comp_2451_dgqcopy
   ...
   output   wire  [8 : 0]         axi_st_data_out_tuser;
   output   wire  [71 : 0]         axi_st_data_out_tdata;
   ...
   intel_vvp_vert_scaler_algo_comp # (
      ...
      .RUNTIME_LOAD              (1),
      .MEM_INIT                  (1),
      .INIT_FILE                 ("pipeline_intel_vvp_pipeline2_0_intel_vvp_vert_scaler_algo_comp_2451_dgqcopy_coeff.mif"),
