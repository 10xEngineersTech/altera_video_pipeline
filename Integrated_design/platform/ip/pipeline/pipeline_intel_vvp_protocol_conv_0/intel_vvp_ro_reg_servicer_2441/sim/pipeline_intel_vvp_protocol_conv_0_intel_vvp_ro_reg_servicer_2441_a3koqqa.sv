...
module pipeline_intel_vvp_protocol_conv_0_intel_vvp_ro_reg_servicer_2441_a3koqqa
   (  clk,
      rst,
   ...
   localparam P_RO_REG_COUNT = 2 + 2;

   localparam integer P_RO_PARAMS [0 : P_RO_REG_COUNT-1] =  '{ P_VID_PID, P_VERSION_NUMBER, 4, 0 };
