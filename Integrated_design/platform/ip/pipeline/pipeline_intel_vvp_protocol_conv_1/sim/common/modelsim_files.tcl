...
namespace eval pipeline_intel_vvp_protocol_conv_1 {
  ...
  proc get_design_files {QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "-makelib intel_vvp_ro_reg_servicer_2441 \"[normalize_path "$QSYS_SIMDIR/../intel_vvp_ro_reg_servicer_2441/sim/pipeline_intel_vvp_protocol_conv_1_intel_vvp_ro_reg_servicer_2441_a3koqqa.sv"]\"   -L altera_common_sv_packages -end"               
    ...
    lappend design_files "-makelib altera_merlin_master_translator_193 \"[normalize_path "$QSYS_SIMDIR/../altera_merlin_master_translator_193/sim/pipeline_intel_vvp_protocol_conv_1_altera_merlin_master_translator_193_lgcew2q.sv"]\"   -L altera_common_sv_packages -end"
    lappend design_files "-makelib altera_merlin_slave_translator_191 \"[normalize_path "$QSYS_SIMDIR/../altera_merlin_slave_translator_191/sim/pipeline_intel_vvp_protocol_conv_1_altera_merlin_slave_translator_191_xg7rzxi.sv"]\"   -L altera_common_sv_packages -end"   
    lappend design_files "-makelib altera_mm_interconnect_1920 \"[normalize_path "$QSYS_SIMDIR/../altera_mm_interconnect_1920/sim/pipeline_intel_vvp_protocol_conv_1_altera_mm_interconnect_1920_epi4vay.v"]\"   -end"                                                      
    lappend design_files "-makelib intel_vvp_slave_front_end_2441 \"[normalize_path "$QSYS_SIMDIR/../intel_vvp_slave_front_end_2441/sim/pipeline_intel_vvp_protocol_conv_1_intel_vvp_slave_front_end_2441_i4nwqui.v"]\"   -end"                                             
    lappend design_files "-makelib altera_mm_interconnect_1920 \"[normalize_path "$QSYS_SIMDIR/../altera_mm_interconnect_1920/sim/pipeline_intel_vvp_protocol_conv_1_altera_mm_interconnect_1920_fcggkmy.v"]\"   -end"                                                      
    lappend design_files "-makelib intel_vvp_protocol_conv_2460 \"[normalize_path "$QSYS_SIMDIR/../intel_vvp_protocol_conv_2460/sim/pipeline_intel_vvp_protocol_conv_1_intel_vvp_protocol_conv_2460_cq2b6jq.v"]\"   -end"                                                   
    lappend design_files "-makelib pipeline_intel_vvp_protocol_conv_1 \"[normalize_path "$QSYS_SIMDIR/pipeline_intel_vvp_protocol_conv_1.v"]\"   -end"                                                                                                                      
    return $design_files
  }
