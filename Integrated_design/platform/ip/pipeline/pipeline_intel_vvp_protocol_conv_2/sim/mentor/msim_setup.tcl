...
# ----------------------------------------
# ACDS 25.1.1 125 linux 2026.07.12.19:49:20
...
alias com {
  ...
  set common_design_files [dict values [pipeline_intel_vvp_protocol_conv_2::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [pipeline_intel_vvp_protocol_conv_2::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
