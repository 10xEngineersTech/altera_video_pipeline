...
module pipeline_intel_vvp_scaler_0_intel_vvp_horiz_scaler_algo_comp_2451_vr7r2ma
   ...
   input    wire  [3 : 0]          axi_st_data_in_tuser;
   input    wire  [31 : 0]          axi_st_data_in_tdata;
   output   wire                             axi_st_data_in_tready;

   output   wire                             axi_st_data_out_tvalid;
   output   wire                             axi_st_data_out_tlast;
   output   wire  [3 : 0]         axi_st_data_out_tuser;
   output   wire  [31 : 0]         axi_st_data_out_tdata;
   ...
   intel_vvp_horiz_scaler_algo_comp #(
      ...
      .RUNTIME_LOAD              (1),
      .MEM_INIT                  (0),
      .INIT_FILE                 ("pipeline_intel_vvp_scaler_0_intel_vvp_horiz_scaler_algo_comp_2451_vr7r2ma_coeff.mif"),
