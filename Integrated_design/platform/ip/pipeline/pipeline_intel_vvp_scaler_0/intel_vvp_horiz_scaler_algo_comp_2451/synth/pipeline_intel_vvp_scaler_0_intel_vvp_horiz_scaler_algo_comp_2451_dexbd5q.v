...
module pipeline_intel_vvp_scaler_0_intel_vvp_horiz_scaler_algo_comp_2451_dexbd5q
   ...
   input    wire  [2 : 0]          axi_st_data_in_tuser;
   input    wire  [23 : 0]          axi_st_data_in_tdata;
   ...
   intel_vvp_horiz_scaler_algo_comp #(
      ...
      .RUNTIME_LOAD              (1),
      .MEM_INIT                  (0),
      .INIT_FILE                 ("pipeline_intel_vvp_scaler_0_intel_vvp_horiz_scaler_algo_comp_2451_dexbd5q_coeff.mif"),
