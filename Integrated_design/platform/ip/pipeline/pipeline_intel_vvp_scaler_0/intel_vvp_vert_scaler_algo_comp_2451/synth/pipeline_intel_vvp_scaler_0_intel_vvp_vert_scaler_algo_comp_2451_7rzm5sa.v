...
module pipeline_intel_vvp_scaler_0_intel_vvp_vert_scaler_algo_comp_2451_7rzm5sa
   ...
   input    wire  [1 : 0]       axi_st_coeff_tuser;
   input    wire  [15 : 0]       axi_st_coeff_tdata;
   ...
   output   wire  [6 : 0]         axi_st_data_out_tuser;
   output   wire  [55 : 0]         axi_st_data_out_tdata;
   ...
   intel_vvp_vert_scaler_algo_comp # (
      ...
      .RUNTIME_LOAD              (1),
      .MEM_INIT                  (0),
      .INIT_FILE                 ("pipeline_intel_vvp_scaler_0_intel_vvp_vert_scaler_algo_comp_2451_7rzm5sa_coeff.mif"),
