...
namespace eval pipeline_intel_vvp_tpg_0 {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_vvp_ro_reg_servicer_2441/sim/pipeline_intel_vvp_tpg_0_intel_vvp_ro_reg_servicer_2441_fggycsa.sv"]\" -L altera_common_sv_packages -work intel_vvp_ro_reg_servicer_2441"               
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_vvp_slave_front_end_2441/sim/pipeline_intel_vvp_tpg_0_intel_vvp_slave_front_end_2441_ceceg2i.v"]\"  -work intel_vvp_slave_front_end_2441"                                                
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_vvp_tpg_2451/sim/pipeline_intel_vvp_tpg_0_intel_vvp_tpg_2451_vwkhzgy.v"]\"  -work intel_vvp_tpg_2451"                                                                                    
