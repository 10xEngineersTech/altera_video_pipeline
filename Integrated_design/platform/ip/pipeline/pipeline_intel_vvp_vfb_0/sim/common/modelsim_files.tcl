...
namespace eval pipeline_intel_vvp_vfb_0 {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_vvp_ro_reg_servicer_2441/sim/pipeline_intel_vvp_vfb_0_intel_vvp_ro_reg_servicer_2441_wkfgrla.sv"]\" -L altera_common_sv_packages -work intel_vvp_ro_reg_servicer_2441"               
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_merlin_master_translator_193/sim/pipeline_intel_vvp_vfb_0_altera_merlin_master_translator_193_lgcew2q.sv"]\" -L altera_common_sv_packages -work altera_merlin_master_translator_193"
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_merlin_slave_translator_191/sim/pipeline_intel_vvp_vfb_0_altera_merlin_slave_translator_191_xg7rzxi.sv"]\" -L altera_common_sv_packages -work altera_merlin_slave_translator_191"   
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_mm_interconnect_1920/sim/pipeline_intel_vvp_vfb_0_altera_mm_interconnect_1920_jcbczky.v"]\"  -work altera_mm_interconnect_1920"                                                         
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_vvp_vfb_2451/sim/pipeline_intel_vvp_vfb_0_intel_vvp_vfb_2451_pdxh2ti.v"]\"  -work intel_vvp_vfb_2451"                                                                                    
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/pipeline_intel_vvp_vfb_0.v"]\"  -work pipeline_intel_vvp_vfb_0"                                                                                                                                   
    return $design_files
  }
