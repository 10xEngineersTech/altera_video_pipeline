...
# ----------------------------------------
# ACDS 25.1.1 125 linux 2026.07.08.20:17:10
...
alias com {
  ...
  set common_design_files [dict values [pipeline_mm_bridge_0::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [pipeline_mm_bridge_0::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
