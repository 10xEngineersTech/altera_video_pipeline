...
alias com {
  ...
  set common_design_files [dict values [pipeline_reset_in::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [pipeline_reset_in::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
