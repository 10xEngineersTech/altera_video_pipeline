// pipeline_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1940_3ux5izy.v

// Generated using ACDS version 25.1.1 125

`timescale 1 ps / 1 ps
module pipeline_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1940_3ux5izy #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 162,
		...
		input  wire [161:0] in_data,           //          .data,          Input Data port of Avalon Streaming Sink Interface
		input  wire [0:0]   in_channel,        //          .channel,       Channel input port of Avalon Streaming Sink Interface
		...
		output wire [161:0] out_data,          //          .data,          Output Data port of Avalon Streaming Source Interface
		output wire [0:0]   out_channel        //          .channel,       Channel output port of Avalon Streaming Source Interface
	);

	pipeline_altera_avalon_st_pipeline_stage_1930_oiupeiq #(
		...
		.in_data           (in_data),           //   input,  width = 162,          .data
		...
		.out_data          (out_data),          //  output,  width = 162,          .data
