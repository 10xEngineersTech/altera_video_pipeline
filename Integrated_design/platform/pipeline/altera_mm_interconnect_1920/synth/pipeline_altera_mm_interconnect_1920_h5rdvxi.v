// pipeline_altera_mm_interconnect_1920_h5rdvxi.v
...
`timescale 1 ps / 1 ps
module pipeline_altera_mm_interconnect_1920_h5rdvxi (
		...
		input  wire         onchip_memory2_0_reset1_reset_bridge_in_reset_reset, // onchip_memory2_0_reset1_reset_bridge_in_reset.reset,      Reset Input
	...
	wire  [413:0] rsp_mux_src_data;                                                                        // rsp_mux:src_data -> intel_vvp_vfb_0_av_mm_mem_write_host_agent:rp_data
	wire          rsp_mux_src_ready;                                                                       // intel_vvp_vfb_0_av_mm_mem_write_host_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                                     // rsp_mux:src_channel -> intel_vvp_vfb_0_av_mm_mem_write_host_agent:rp_channel
	...
	wire  [162:0] onchip_memory2_0_s1_agent_rf_source_data;                                                // onchip_memory2_0_s1_agent:rf_source_data -> onchip_memory2_0_s1_agent_rsp_fifo:in_data
	...
	wire  [162:0] onchip_memory2_0_s1_agent_rsp_fifo_out_data;                                             // onchip_memory2_0_s1_agent_rsp_fifo:out_data -> onchip_memory2_0_s1_agent:rf_sink_data
	...
	wire  [413:0] intel_vvp_vfb_0_av_mm_mem_write_host_agent_cp_data;                                      // intel_vvp_vfb_0_av_mm_mem_write_host_agent:cp_data -> router:sink_data
	...
	wire  [161:0] onchip_memory2_0_s1_agent_rp_data;                                                       // onchip_memory2_0_s1_agent:rp_data -> router_001:sink_data
	...
	wire  [161:0] onchip_memory2_0_s1_burst_adapter_source0_data;                                          // onchip_memory2_0_s1_burst_adapter:source0_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [161:0] router_001_src_data;                                                                     // router_001:src_data -> onchip_memory2_0_s1_rsp_width_adapter:in_data
	...
	wire  [413:0] onchip_memory2_0_s1_rsp_width_adapter_src_data;                                          // onchip_memory2_0_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire  [413:0] cmd_mux_src_data;                                                                        // cmd_mux:src_data -> onchip_memory2_0_s1_cmd_width_adapter:in_data
	...
	wire  [161:0] onchip_memory2_0_s1_cmd_width_adapter_src_data;                                          // onchip_memory2_0_s1_cmd_width_adapter:out_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	pipeline_altera_merlin_slave_agent_1930_jxauz3i #(
		...
		.rp_data                 (onchip_memory2_0_s1_agent_rp_data),                       //  output,  width = 162,                .data
		...
		.cp_data                 (onchip_memory2_0_s1_burst_adapter_source0_data),          //   input,  width = 162,                .data
		...
		.rf_sink_data            (onchip_memory2_0_s1_agent_rsp_fifo_out_data),             //   input,  width = 163,                .data
		...
		.rf_source_data          (onchip_memory2_0_s1_agent_rf_source_data),                //  output,  width = 163,                .data
	...
	pipeline_altera_avalon_sc_fifo_1932_onpcouq #(
		...
		.clk               (clock_in_out_clk_clk),                                 //   input,    width = 1,       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),  //   input,    width = 1, clk_reset.reset
		.in_data           (onchip_memory2_0_s1_agent_rf_source_data),             //   input,  width = 163,        in.data
		...
		.out_data          (onchip_memory2_0_s1_agent_rsp_fifo_out_data),          //  output,  width = 163,       out.data
	...
	pipeline_altera_merlin_router_1921_vvh72si router_001 (
		...
		.sink_data          (onchip_memory2_0_s1_agent_rp_data),                   //   input,  width = 162,          .data
	...
	pipeline_altera_merlin_burst_adapter_1940_nwcdjmq #(
		...
		.sink0_data            (onchip_memory2_0_s1_cmd_width_adapter_src_data),          //   input,  width = 162,          .data
		.sink0_channel         (onchip_memory2_0_s1_cmd_width_adapter_src_channel),       //   input,    width = 1,          .channel
		...
		.source0_data          (onchip_memory2_0_s1_burst_adapter_source0_data),          //  output,  width = 162,          .data
	...
	pipeline_altera_merlin_demultiplexer_1921_x6yjluq rsp_demux (
		...
		.sink_channel       (onchip_memory2_0_s1_rsp_width_adapter_src_channel),       //   input,    width = 1,          .channel
		.sink_data          (onchip_memory2_0_s1_rsp_width_adapter_src_data),          //   input,  width = 414,          .data
	...
	pipeline_altera_merlin_width_adapter_1961_v6j5a2a #(
		...
		.out_data             (onchip_memory2_0_s1_rsp_width_adapter_src_data),          //  output,  width = 414,          .data
		.out_channel          (onchip_memory2_0_s1_rsp_width_adapter_src_channel),       //  output,    width = 1,          .channel
	...
	pipeline_altera_merlin_width_adapter_1961_sjmxhvi #(
		...
		.out_data             (onchip_memory2_0_s1_cmd_width_adapter_src_data),          //  output,  width = 162,          .data
		.out_channel          (onchip_memory2_0_s1_cmd_width_adapter_src_channel),       //  output,    width = 1,          .channel
