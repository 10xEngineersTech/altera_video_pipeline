	component pipeline is
		port (
			...
			intel_vvp_crs_0_axi4s_vid_in_tdata                    : in  std_logic_vector(15 downto 0) := (others => 'X'); -- tdata
			...
			intel_vvp_crs_0_axi4s_vid_in_tuser                    : in  std_logic_vector(1 downto 0)  := (others => 'X'); -- tuser
