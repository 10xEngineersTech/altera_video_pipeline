	component pipeline is
		port (
			...
			intel_vvp_mixer_0_axi4s_vid_1_in_tdata                      : in  std_logic_vector(23 downto 0) := (others => 'X'); -- tdata
			intel_vvp_mixer_0_axi4s_vid_1_in_tvalid                     : in  std_logic                     := 'X';             -- tvalid
			intel_vvp_mixer_0_axi4s_vid_1_in_tready                     : out std_logic;                                        -- tready
			intel_vvp_mixer_0_axi4s_vid_1_in_tlast                      : in  std_logic                     := 'X';             -- tlast
			intel_vvp_mixer_0_axi4s_vid_1_in_tuser                      : in  std_logic_vector(2 downto 0)  := (others => 'X'); -- tuser
	...
	u0 : component pipeline
		port map (
			...
			intel_vvp_mixer_0_axi4s_vid_1_in_tdata                      => CONNECTED_TO_intel_vvp_mixer_0_axi4s_vid_1_in_tdata,                      --              intel_vvp_mixer_0_axi4s_vid_1_in.tdata
			intel_vvp_mixer_0_axi4s_vid_1_in_tvalid                     => CONNECTED_TO_intel_vvp_mixer_0_axi4s_vid_1_in_tvalid,                     --                                              .tvalid
			intel_vvp_mixer_0_axi4s_vid_1_in_tready                     => CONNECTED_TO_intel_vvp_mixer_0_axi4s_vid_1_in_tready,                     --                                              .tready
			intel_vvp_mixer_0_axi4s_vid_1_in_tlast                      => CONNECTED_TO_intel_vvp_mixer_0_axi4s_vid_1_in_tlast,                      --                                              .tlast
			intel_vvp_mixer_0_axi4s_vid_1_in_tuser                      => CONNECTED_TO_intel_vvp_mixer_0_axi4s_vid_1_in_tuser,                      --                                              .tuser
