...
# ----------------------------------------
# ACDS 25.1.1 125 linux 2026.07.08.20:17:24
...
set logical_libraries [list "work" "work_lib" "lpm_ver" "sgate_ver" "altera_ver" "altera_mf_ver" "altera_lnsim_ver" "tennm_ver" "tennm_sm_hps_ver" "tennm_fmm3_hssi_ver" "tennm_revb_hvio_ver" "tennm_revb_io96_ver" "lpm" "sgate" "altera" "altera_mf" "altera_lnsim" "tennm" "tennm_sm_hps" "tennm_fmm3_hssi" "tennm_revb_hvio" "tennm_revb_io96"]
...
if [ check_precomp_device $PRECOMP_DEVICE_LIB_FILE $FORCE_MODELSIM_AE_SELECTION ] {
  ...
  ensure_lib                     ./libraries/tennm_fmm3_hssi/    
  vmap       tennm_fmm3_hssi     ./libraries/tennm_fmm3_hssi/    
...
alias dev_com {
  ...
  if [ check_precomp_device $PRECOMP_DEVICE_LIB_FILE $FORCE_MODELSIM_AE_SELECTION ] {
    eval  qrun -compile -noautoorder -parallel -outdir ./libraries -vlog.options $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS -end \
     ...
     -makelib tennm_fmm3_hssi "$DEVICES_SIM_LIB_DIR/tennm_fmm3_hssi.sv" -end \
     -makelib tennm_fmm3_hssi "$DEVICES_SIM_LIB_DIR/tennm_fmm3_hssi_ncrypt.sv"  -suppress 7061,2583,13314,2244,2283,2600,3691 -end \
...
alias com {
  ...
  set common_design_files [dict values [pipeline::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [pipeline::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
