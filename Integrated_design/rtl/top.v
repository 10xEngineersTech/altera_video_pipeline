    ...
    always @(posedge clk or posedge reset) begin
        if (reset) begin
            ...
            case (current_state)
                    ...
                    if (cfg_step == 4'd0) begin
                        ...
                        if (csc_readdatavalid) begin
                            ...
                            if (csc_readdata[1] == 1'b0)
                                current_state <= INPUT_SEL ? ST_CONFIG_PC1 : ST_WORKING;
                            // else re-poll
                        end
                    end
                end
                ...
                // Register map (from IPs/protocol_converter testbench):
                ...
                ST_CONFIG_PC1: begin
                    pc1_write <= 1'b1;
                    case (cfg_step)
                        4'd0: begin pc1_addr <= PC1_ADDR_WIDTH;       pc1_wdata <= IMG_WIDTH;  end
                        ...
                        4'd4: begin pc1_addr <= PC1_ADDR_SUBSAMPLING; pc1_wdata <= 32'h0;      end
