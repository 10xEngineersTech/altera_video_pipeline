...
//   1. Platform subsystem  – system.qsys  (TPG 32x32 -> Clipper 24x24 -> Scaler)
//   2. Checker             – vid_checker.v (monitors scaler output for validation)
//
...
// it is synthesizable except for checker.v's $display statements.
//
// Port summary
// ─────────────────────────────────────────────────────────────────────────────
//  CLOCK / RESET
