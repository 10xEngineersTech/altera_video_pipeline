...
IPs are connected in this order with mentioned default configurations in the integrated design.

```mermaid
graph LR
    A[TPG] -- "AXIS Full (YUV422 Interlaced)" --> DIL[Deinterlacer]
...
| :--- | :--- | :--- | :--- |
| **Test Pattern Generator (TPG)** | Source generation | Dynamic resolution, AXI4-Stream Full mode (YUV422 interlaced output) | Reconfigurable |
